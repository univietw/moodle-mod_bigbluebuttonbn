...
class config {
    ...
    public static function defaultvalues() {
        return array(
            ...
            'skipcheckaudio_default' => false,
            'skipcheckaudio_editable' => true,
    ...
    public static function get_options() {
        return array(
               ...
               'skipcheckaudio_editable' => self::get('skipcheckaudio_editable'),
               'skipcheckaudio_default' => self::get('skipcheckaudio_default'),
